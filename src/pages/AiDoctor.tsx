    ...
    <Layout>
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <Card className="border-0 shadow-lg overflow-hidden bg-gradient-to-br from-white to-red-50">
            <CardHeader className="bg-red-500 bg-opacity-90 text-white space-y-2">
