      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-amber-50 p-4 rounded-md border border-amber-200 mt-6">
                    <p className="text-amber-800 text-sm">
                      ...
                      please call emergency services directly at 102 while waiting for the ambulance.
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 text-gray-700">
                      ...
                      <span>{address || "Gandhi Nagar, New Delhi"}</span>
                    </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            <p>
              <strong>Note:</strong> In a real emergency, always call your local emergency services number directly (102 for ambulance in India).
